...
public class Driver extends TableImpl<Record> {
   ...
   */
  public final TableField<Record, String> LAST_NAME = createField(DSL.name("last_name"),
      SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>fleet.driver.first_name</code>.
   */
  public final TableField<Record, String> FIRST_NAME = createField(DSL.name("first_name"),
      SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>fleet.driver.seniority</code>.
   */
  public final TableField<Record, Integer> SENIORITY = createField(DSL.name("seniority"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>fleet.driver.title</code>.
   */
  public final TableField<Record, String> TITLE = createField(DSL.name("title"),
      SQLDataType.VARCHAR(255), this, "");
