...
public class Insurance extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, BigDecimal> INSURANCE_COST = createField(DSL.name("insurance_cost"), SQLDataType.NUMERIC(19, 2), this, "");

    /**
     * The column <code>fleet.insurance.insurance_expiration_date</code>.
     */
    public final TableField<Record, LocalDate> INSURANCE_EXPIRATION_DATE = createField(DSL.name("insurance_expiration_date"), SQLDataType.LOCALDATE, this, "");

    /**
     * The column <code>fleet.insurance.insurance_name</code>.
     */
    public final TableField<Record, String> INSURANCE_NAME = createField(DSL.name("insurance_name"), SQLDataType.VARCHAR(255), this, "");
