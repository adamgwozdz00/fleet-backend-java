...
public class Overview extends TableImpl<Record> {
   ...
   */
  public final TableField<Record, BigDecimal> OVERVIEW_COST = createField(DSL.name("overview_cost"),
      SQLDataType.NUMERIC(19, 2), this, "");
  /**
   * The column <code>fleet.overview.overview_description</code>.
   */
  public final TableField<Record, String> OVERVIEW_DESCRIPTION = createField(
      DSL.name("overview_description"), SQLDataType.CLOB, this, "");
  /**
   * The column <code>fleet.overview.overview_expiration_date</code>.
   */
  public final TableField<Record, LocalDate> OVERVIEW_EXPIRATION_DATE = createField(
      DSL.name("overview_expiration_date"), SQLDataType.LOCALDATE, this, "");
  /**
   * The column <code>fleet.overview.overview_name</code>.
   */
  public final TableField<Record, String> OVERVIEW_NAME = createField(DSL.name("overview_name"),
