...
public class Vehicle extends TableImpl<Record> {
   ...
   */
  public final TableField<Record, Long> COMPANY_ID = createField(DSL.name("company_id"),
      SQLDataType.BIGINT, this, "");
  /**
   * The column <code>fleet.vehicle.production_year</code>.
   */
  public final TableField<Record, Integer> PRODUCTION_YEAR = createField(
      DSL.name("production_year"), SQLDataType.INTEGER, this, "");
  /**
   * The column <code>fleet.vehicle.fuel_type</code>.
   */
  public final TableField<Record, String> FUEL_TYPE = createField(DSL.name("fuel_type"),
      SQLDataType.VARCHAR(10), this, "");
  /**
   * The column <code>fleet.vehicle.make</code>.
   */
  public final TableField<Record, String> MAKE = createField(DSL.name("make"),
      SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>fleet.vehicle.model</code>.
   */
  public final TableField<Record, String> MODEL = createField(DSL.name("model"),
      SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>fleet.vehicle.vin_number</code>.
   */
  public final TableField<Record, String> VIN_NUMBER = createField(DSL.name("vin_number"),
      SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>fleet.vehicle.insurance_id</code>.
   */
  public final TableField<Record, Long> INSURANCE_ID = createField(DSL.name("insurance_id"),
      SQLDataType.BIGINT, this, "");
  /**
   * The column <code>fleet.vehicle.overview_id</code>.
   */
  public final TableField<Record, Long> OVERVIEW_ID = createField(DSL.name("overview_id"),
      SQLDataType.BIGINT, this, "");
  /**
   * The column <code>fleet.vehicle.state_id</code>.
   */
  public final TableField<Record, Long> STATE_ID = createField(DSL.name("state_id"),
      SQLDataType.BIGINT, this, "");
  ...
  public List<ForeignKey<Record, ?>> getReferences() {
    return Arrays.asList(Keys.VEHICLE__FKINSURANCE, Keys.VEHICLE__FKOVERVIEW,
        Keys.VEHICLE__FKVEHICLESTATE);
  }
